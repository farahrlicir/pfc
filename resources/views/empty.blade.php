...
<body class="bg-purple-100 xl:overflow-hidden">
    <div class="mt-20">
   ...
   <div class="md:grid md:grid-cols-2 md:gap-4 md:my-44 sm:grid sm:grid-rows-2">
     <div class="grid grid-rows-2 gap-4 justify-center">
       ...
       <h2>
        <a href="{{route('dashboard')}}" class="font-bold text-xl xl:ml-12 sm:text-sm sm:ml-12">USER</a>
       </h2>
     </div>
     <div class="grid grid-rows-2 gap-4 justify-center">
        <img src="/img/gif.gif"  class="w-40 h-40 border-y-2 border-x-2 border-purple-900 border-double">
       <h2>
        <a href="welcome" class="font-bold text-xl ml-11 sm:text-sm ">VISITOR</a>
       </h2>
     </div>
   </div>
